...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="d-flex flex-row-revers">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/ewak/register">
    ...
    <div class="deskripsi container mt-5">
        <div class="row">
            ...
            <div class="col-md-6 col-12">
                <img src="{{url('assets/iwak15.jpeg')}}" class="img-produk-lg" alt="">
                <img src="{{url('assets/iwak15.jpeg')}}" class="img-produk-lg-mobile" alt="">
            </div>
            <div class="col-md-6 col-12">
                <div class="row">
                    <div class="col">
                        <h4>Ikan Mujaer</h4>
                        <small>Berat 0,42 Kg</small>
                        <h3>Rp 42.000</h3>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col">
                        <a href="#" class="mt-3 btn btn-lg btn-ikan">Beli</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <nav class="navbar-bottom shadow-lg navbar fixed-bottom navbar-light" style="background-color: orangered;">
        ...
        <a class="nav-link" href="keranjang.html" style="color: white">
